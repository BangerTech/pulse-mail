...
App-ID: `de.bangertech.pulsemail.winui` · Version **1.0.6**
...
| Datei | Nutzen |
|-------|--------|
| `PulseMail-Native-1.0.6-Setup.exe` | **Inno-Setup-Wizard** (Sprache, Zielordner, Startmenü, Desktop-Icon, Starten) |
| `PulseMail-Native-1.0.6-win-x64.zip` | Portable Variante ohne Installation |

Release-Tag: `native-v1.0.6`.
