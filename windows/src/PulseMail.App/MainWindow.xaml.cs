...
public sealed partial class MainWindow : Window
{
    ...
    private int _dragTarget; // 0 sidebar, 1 list
    ...
    private async void LoadRemote_Click(object sender, RoutedEventArgs e)
    {
        ...
        // Keep global setting; allowlist unlocks this sender. Rebuild with block still on if setting off.
    ...
    private async void RootGrid_KeyDown(object sender, KeyRoutedEventArgs e)
    {
        ...
        switch (key)
        {
            ...
            case VirtualKey.V when !ctrl:
                {
                    var dest = await Helpers.MoveFolderDialog.PickAsync(Content.XamlRoot, ViewModel);
