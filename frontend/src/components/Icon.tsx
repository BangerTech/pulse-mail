const PATHS: Record<string, JSX.Element> = {
  ...
  link: (
    <>
      ...
      <path d="M9.5 14.5L7.5 16.5C6.1 17.9 3.9 17.9 2.5 16.5C1.1 15.1 1.1 12.9 2.5 11.5L4.5 9.5" />
      <path d="M10.5 5.5L12.5 3.5C13.9 2.1 16.1 2.1 17.5 3.5C18.9 4.9 18.9 7.1 17.5 8.5L15.5 10.5" />
    </>
  ),
  image: (
    <>
      ...
      <path d="M2.5 13.5L7 10L10.5 12.5L13 10.5L17.5 14" />
    </>
  ),
  download: (
    <>
